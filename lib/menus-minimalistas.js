...
function menuInformes() {
    return [
        ...
        '3) 📦 Materiales & Riesgos',
        '4) 👥 Asistencia (MARCADOR | EN TURNO)',
        '5) 📋 Permisos (resumen mes)',
        '6) 📅 Resumen Operativo Completo',
        '0) ← Atrás',
        '',
        'Responde 0-6'
    ].join('\n');
...
function detalleAyudaMateriales() {
    return [
        '📦 MATERIALES / INSUMOS',
        '',
