...
function menuConfigurar() {
    return [
        ...
        '4) 🛑 Control de Emergencia del Bot',
        '0) ← Atrás',
        '',
        'Responde 0-4'
    ].join('\n');
...
function detalleAyudaAsistencia() {
    return [
        ...
        '• BOT STOP o BOT PAUSA — pausa inmediata',
        '• BOT START o BOT REANUDAR — reactivar',
        '• BOT STATUS — ver estado actual',
        '• BOT RESET — limpiar caches y reiniciar schedulers'
    ].join('\n');
}
